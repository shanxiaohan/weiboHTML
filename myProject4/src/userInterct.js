define(function (require, exports, module) {
    ...
    function interactTrend () {
        ...
        $("#expand_btn").click(function(){
           ...
           type: 'GET',
             //url:'../test/cloud.json',
            url:'http://10.109.247.246/server/emotionTrend.php?topic_id='+topic_id+'&zoom=2',
            dataType: 'jsonp',
            jsonp:'callback',
            async: false, //同步执行
    ...
    return {
      ...
      $("#reset_btn").click(function(){
           ...
           type: 'GET',
             //url:'../test/cloud.json',
            url:'http://10.109.247.246/server/emotionTrend.php?topic_id='+topic_id+'&zoom=1',
            dataType: 'jsonp',
            jsonp:'callback',
            async: false, //同步执行
            success:function(data){
...
$("#contract_btn").click(function(){
           ...
           type: 'GET',
             //url:'../test/cloud.json',
            url:'http://10.109.247.246/server/emotionTrend.php?topic_id='+topic_id+'&zoom=0',
            dataType: 'jsonp',
            jsonp:'callback',
            async: false, //同步执行
            success:function(data){
